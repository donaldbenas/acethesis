		...
		<table class="table table-hover table-striped table-bordered">
		  <thead>
			<tr>
				<th>INVOICE #</th>
				<th>PRICE</th>
				<th width="200px"><a class="btn" id="add-new" href="<?php echo base_url()."transact/regular/new" ?>" onclick="return false"><i class="icon-plus"></i> New Transaction</a></th>
			</tr>
		  </thead>
			<?php 
			$subtotal=0;
			...
			<tr>
				...
				<td>		
				 <a class="btn btn-primary" id="edit-me<?php echo $count?>" href="<?php echo base_url()."transact/regular/edit/".$rows->fld_invoiceID ?>" onclick="return false"><i class="icon-pencil icon-white"></i> Edit</a>
...
<script>
	...
	function erase(id,name){
		...
		$('#modal-footer-delete').attr("href","<?php echo base_url()."transact/regular/delete/" ?>"+id);
	}
</script>
